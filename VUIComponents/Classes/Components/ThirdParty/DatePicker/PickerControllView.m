...
-(void)loadDate{
    ...
    [self.pickerDelegate datePickerReturn:chosenDateString andDate:self.chosenDate]  ;
}
...
//
//    NSDate *date = self.selectDateView.chosenDate;
//    unsigned unitFlags = NSCalendarUnitYear | NSCalendarUnitMonth |  NSCalendarUnitDay;
//    
//    NSCalendar *gregorian = [NSCalendar currentCalendar];
//    NSDateComponents *comps = [gregorian components:unitFlags fromDate:self.selectDateView.chosenDate];
//    [comps setYear:[comps year] + 1];
//    date = [gregorian dateFromComponents:comps];
//    if ( [date compare:self.maximumDate] == NSOrderedAscending) {
//        
//        NSString *finalDateString = [self.dateFormatter stringFromDate:self.chosenDate];
//        [self.pickerDelegate datePickerReturn:finalDateString andDate: self.chosenDate];
//        [self removeSubViews];
//        
//    }
//    
